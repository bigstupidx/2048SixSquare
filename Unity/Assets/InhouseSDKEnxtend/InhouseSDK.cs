...
public partial class InhouseSDK : MonoBehaviour {
	public const string FB_EVENT_SCORE_30 = "FB_EVENT_SCORE_30";
	...
	public const string FB_EVENT_OPEN_GAMEPROMOTE = "FB_EVENT_OPEN_GAMEPROMOTE";
	public const string FB_EVENT_CLICK_GAMEPROMOTE = "FB_EVENT_CLICK_GAMEPROMOTE";
	public const string FB_EVENT_USING_REBORN = "FB_EVENT_USING_REBORN";
	public const string FB_EVENT_CLICK_RATE_MENU = "FB_EVENT_CLICK_RATE_MENU";
	public const string FB_EVENT_CLICK_RATE_POPUP = "FB_EVENT_CLICK_RATE_POPUP";
	public const string FB_EVENT_CLICK_STARTGAME = "FB_EVENT_CLICK_STARTGAME";
